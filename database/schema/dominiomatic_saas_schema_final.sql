...
--
-- Host: 127.0.0.1    Database: dominiomatic_saas
-- ------------------------------------------------------
...
CREATE TABLE `companies` (
  ...
  `primary_color` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#007AFF',
  `secondary_color` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#5856D6',
...
CREATE TABLE `subscription_attributes` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `subscription_attributes_company_id_foreign` (`company_id`),
  CONSTRAINT `subscription_attributes_company_id_foreign` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `subscription_values`
--

DROP TABLE IF EXISTS `subscription_values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `subscription_values` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `subscription_id` bigint unsigned NOT NULL,
  `subscription_attribute_id` bigint unsigned NOT NULL,
  `value` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `subscription_values_subscription_id_foreign` (`subscription_id`),
  KEY `subscription_values_subscription_attribute_id_foreign` (`subscription_attribute_id`),
  CONSTRAINT `subscription_values_subscription_attribute_id_foreign` FOREIGN KEY (`subscription_attribute_id`) REFERENCES `subscription_attributes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `subscription_values_subscription_id_foreign` FOREIGN KEY (`subscription_id`) REFERENCES `subscriptions` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `subscriptions` (
  ...
  KEY `subscriptions_contact_id_foreign` (`contact_id`),
  ...
  CONSTRAINT `subscriptions_contact_id_foreign` FOREIGN KEY (`contact_id`) REFERENCES `contacts` (`id`) ON DELETE CASCADE,
...
--
-- Dumping routines for database 'dominiomatic_saas'
--
--
...
-- Dump completed on 2026-06-24 23:29:49
