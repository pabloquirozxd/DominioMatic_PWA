    ...
    <section class="space-y-6">
        <header>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Una vez que tu cuenta sea eliminada, todos sus recursos y datos se borrarán permanentemente. Antes de eliminarla, descarga cualquier información que desees conservar.
            </p>
        </header>
